#!/usr/bin/env python3
"""Resampling Methods And Model Evaluation — Cheatsheet exécutable
...
def demo():
    ...
    section("Demo 1")
    print("Hello from Resampling Methods And Model Evaluation!")
...
def main():
    section("Resampling Methods And Model Evaluation")
    theory_flash()
    demo()
