#!/usr/bin/env python3
"""Mathematical Details And Demonstrations — Cheatsheet exécutable
...
def demo():
    ...
    section("Demo 1")
    print("Hello from Mathematical Details And Demonstrations!")
...
def main():
    section("Mathematical Details And Demonstrations")
    theory_flash()
    demo()
